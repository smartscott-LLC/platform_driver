...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L noc_nps_v1_0_2 -L axi_vip_v1_1_22 -L smartconnect_v1_0 -L versal_cips_ps_vip_v1_0_14 -L clk_gen_sim_v1_0_6 -L cpm5_v1_0_20 -L cpm4_v1_0_20 -L noc_hbm_nmu_sim_v1_0_0 -L noc_nmu_sim_v1_0_0 -L emb_mem_gen_v1_0_11 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L noc_nps_v1_0_2 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot xlnoc xil_defaultlib.xlnoc xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim xlnoc -key {Behavioral:sim_1:Functional:xlnoc} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_8be5.protoinst" -protoinst "protoinst_files/bd_70da.protoinst" -protoinst "protoinst_files/design_1.protoinst" -protoinst "protoinst_files/xlnoc.protoinst" -log simulate.log
}
