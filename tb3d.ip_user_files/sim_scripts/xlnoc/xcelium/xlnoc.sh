...
#
# Script generated by Vivado on Tue Mar 24 17:22:12 CDT 2026
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname noc_nps_v1_0_2 -libname xil_defaultlib -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm noc_nps_v1_0_2 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "xlnoc.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../tb3d.gen/sim_1/bd/xlnoc/ipshared/d993/hdl/bfm" +incdir+"../../../../../../AMD/2025.2/data/rsb/busdef" +incdir+"/home/smartscott/AMD/2025.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../tb3d.gen/sim_1/bd/xlnoc/ipshared/d993/hdl/bfm" +incdir+"../../../../../../AMD/2025.2/data/rsb/busdef" +incdir+"/home/smartscott/AMD/2025.2/data/xilinx_vip/include" \
  ...
  xmvlog -work noc_nps_v1_0_2 $xmvlog_opts -sv +incdir+"../../../../tb3d.gen/sim_1/bd/xlnoc/ipshared/d993/hdl/bfm" +incdir+"../../../../../../AMD/2025.2/data/rsb/busdef" +incdir+"/home/smartscott/AMD/2025.2/data/xilinx_vip/include" \
  "../../../../tb3d.gen/sim_1/bd/xlnoc/ipshared/d993/hdl/noc_nps_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../../tb3d.gen/sim_1/bd/xlnoc/ipshared/d993/hdl/bfm" +incdir+"../../../../../../AMD/2025.2/data/rsb/busdef" +incdir+"/home/smartscott/AMD/2025.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../tb3d.gen/sim_1/bd/xlnoc/ipshared/d993/hdl/bfm" +incdir+"../../../../../../AMD/2025.2/data/rsb/busdef" +incdir+"/home/smartscott/AMD/2025.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.xlnoc xil_defaultlib.glbl
}
...
Usage: xlnoc.sh [-rerun]\n\
Usage: xlnoc.sh [-reset_run]\n\
Usage: xlnoc.sh [-clean]\n\
