...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L noc_nps_v1_0_2 -L clk_gen_sim_v1_0_6 -L smartconnect_v1_0 -L axi_vip_v1_1_22 -L xilinx_vip"
...
simulate()
{
  xsim design_1 -key {Behavioral:sim_1:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_6e42.protoinst" -protoinst "protoinst_files/design_1.protoinst" -protoinst "protoinst_files/xlnoc.protoinst" -log simulate.log
}
