...
design_libs=(xilinx_vip xpm xil_defaultlib proc_sys_reset_v5_0_17 smartconnect_v1_0 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_36 axi_vip_v1_1_22 clk_gen_sim_v1_0_6)
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/smartscott/platform_driver/tb3d.cache/compile_simlib/vcs"
  fi
