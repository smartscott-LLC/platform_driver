...
#
# Script generated by Vivado on Thu Mar 26 01:23:33 CDT 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : full_blown.sh
...
#
# Usage        : full_blown.sh
#                full_blown.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                full_blown.sh [-rerun]
#                full_blown.sh [-reset_run]
#                full_blown.sh [-clean]
#                full_blown.sh [-reset_log]
#                full_blown.sh [-help]
#
...
export RDI_DATADIR="/home/smartscott/AMD/2025.2/data"

# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L smartconnect_v1_0 -L noc_nps_v1_0_2 -L noc_nsu_sim_v1_0_1 -L noc_hbm_nmu_sim_v1_0_0 -L noc_nmu_sim_v1_0_0 -L clk_gen_sim_v1_0_6 -L axi_vip_v1_1_22 -L versal_cips_ps_vip_v1_0_14 -L emb_mem_gen_v1_0_11 -L cpm5_v1_0_20 -L cpm4_v1_0_20 -L xilinx_vip"
...
# script info
echo -e "full_blown.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./full_blown.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/smartscott/AMD/2025.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb full_blown.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./full_blown.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: full_blown.sh [-help]\n\
Usage: full_blown.sh [-step]\n\
Usage: full_blown.sh [-lib_map_path]\n\
Usage: full_blown.sh [-rerun]\n\
Usage: full_blown.sh [-reset_run]\n\
Usage: full_blown.sh [-clean]\n\
Usage: full_blown.sh [-reset_log]\n\
Usage: full_blown.sh [-keep_index]\n\
Usage: full_blown.sh [-noclean_files]\n\n\
