...
cpm5_v1_0_20_versal_smsw_sys_clk_gen_ps #(.offset(7500),.halfcycle(500))  clk_gen_1000 (.sys_clk(clk_1000));
cpm5_v1_0_20_versal_smsw_sys_clk_gen_ps #(.offset(7000),.halfcycle(1000)) clk_gen_500  (.sys_clk(clk_500));
cpm5_v1_0_20_versal_smsw_sys_clk_gen_ps #(.offset(6000),.halfcycle(2000)) clk_gen_250  (.sys_clk(clk_250));
cpm5_v1_0_20_versal_smsw_sys_clk_gen_ps #(.offset(4000),.halfcycle(4000)) clk_gen_125  (.sys_clk(clk_125));
cpm5_v1_0_20_versal_smsw_sys_clk_gen_ps #(.offset(0000),.halfcycle(8000)) clk_gen_62_5 (.sys_clk(clk_62_5));
