...
module full_blown_clk_wiz_0_clocking_cmt_dpll_fd_cal #( parameter T_CAL         = 512    // ref clk counter for DCO calibration 
)(
...
full_blown_clk_wiz_0_clocking_Synchronizer3 Isync_rst (
   .si (1'b0), .se (1'b0), .d  (1'b1),
   .ck (ref_clk), .rn (!rst), .q  (rst_sync_n)
   );

full_blown_clk_wiz_0_clocking_Synchronizer3 Isync_drst (
   .si (1'b0), .se (1'b0), .d  (1'b1),
...
full_blown_clk_wiz_0_clocking_Synchronizer3 Isync_locked (
   .si (1'b0), .se (1'b0), .d  (locked_i),
   .ck (ref_clk), .rn (!rst), .q  (locked)
   );

`ifdef DEFINE_SYNC_RST
full_blown_clk_wiz_0_clocking_Synchronizer3 Isync_dco_en (
