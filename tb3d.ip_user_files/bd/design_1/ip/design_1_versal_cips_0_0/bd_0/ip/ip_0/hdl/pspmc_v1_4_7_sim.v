...
`include "pmc_slave2_ports.v"
`include "pmc_slave3_ports.v"
...
generate
  if (C_SLR2_PS_USE_CAPTURE == 1) begin 
    assign slr2_captureclk_temp  = slr2_captureclk ;
    assign slr2_captureb_temp  = slr2_captureb ;
  end
  else begin
    assign slr2_captureclk_temp  = 1'b1 ;
    assign slr2_captureb_temp  = 1'b1 ;
  end
endgenerate

generate
  if (C_SLR3_PS_USE_CAPTURE == 1) begin 
    assign slr3_captureclk_temp  = slr3_captureclk ;
    assign slr3_captureb_temp  = slr3_captureb ;
  end
  else begin
    assign slr3_captureclk_temp  = 1'b1 ;
    assign slr3_captureb_temp  = 1'b1 ;
  end
endgenerate
...
//assign  slr2_hsm0_ref_clk = slr2_hsm_ref_clk[0];
//assign  slr2_hsm1_ref_clk = slr2_hsm_ref_clk[1];

//assign  slr3_hsm0_ref_clk = slr3_hsm_ref_clk[0];
//assign  slr3_hsm1_ref_clk = slr3_hsm_ref_clk[1];
...
`include "pmc_slave1_vip_inst.v"
  versal_cips_ps_vip_0  PS9_VIP_SLV2_inst ( 
`include "pmc_slave2_vip_inst.v"
  versal_cips_ps_vip_0  PS9_VIP_SLV3_inst ( 
`include "pmc_slave3_vip_inst.v"
