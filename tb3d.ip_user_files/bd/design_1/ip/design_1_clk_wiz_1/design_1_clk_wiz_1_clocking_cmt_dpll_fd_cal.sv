...
module design_1_clk_wiz_1_clocking_cmt_dpll_fd_cal #( parameter T_CAL         = 512    // ref clk counter for DCO calibration 
)(
...
design_1_clk_wiz_1_clocking_Synchronizer3 Isync_rst (
   .si (1'b0), .se (1'b0), .d  (1'b1),
   .ck (ref_clk), .rn (!rst), .q  (rst_sync_n)
   );

design_1_clk_wiz_1_clocking_Synchronizer3 Isync_drst (
   .si (1'b0), .se (1'b0), .d  (1'b1),
...
design_1_clk_wiz_1_clocking_Synchronizer3 Isync_locked (
   .si (1'b0), .se (1'b0), .d  (locked_i),
   .ck (ref_clk), .rn (!rst), .q  (locked)
   );

`ifdef DEFINE_SYNC_RST
design_1_clk_wiz_1_clocking_Synchronizer3 Isync_dco_en (
