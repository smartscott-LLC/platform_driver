# file: full_blown_mdm_1_0_ooc_trace.xdc
...
create_clock -name bscan_ext_update -period 60.0 [get_ports bscan_ext_update]
create_clock -name bscan_ext_drck   -period 30.0 [get_ports bscan_ext_drck]
