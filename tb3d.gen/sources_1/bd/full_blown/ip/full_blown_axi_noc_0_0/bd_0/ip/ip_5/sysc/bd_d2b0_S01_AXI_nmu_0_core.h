...
//
//**********************************************************************
#ifndef _bd_d2b0_S01_AXI_nmu_0_core_h_
#define _bd_d2b0_S01_AXI_nmu_0_core_h_

#include "NOCMasterUnitXtlm.h"
#include "properties.h"

class bd_d2b0_S01_AXI_nmu_0_core : public NOCMasterUnitXtlm
{
public:
...
bd_d2b0_S01_AXI_nmu_0_core( sc_core::sc_module_name nm, const xsc::common_cpp::properties& props )
  ...
  virtual ~bd_d2b0_S01_AXI_nmu_0_core() = default;
