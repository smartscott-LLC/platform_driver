...
//
//**********************************************************************
#ifndef bd_d2b0_MC0_ddrc_0_core_h_
#define bd_d2b0_MC0_ddrc_0_core_h_

#include "NOCDdrMcXtlm.h"
#include "properties.h"

class bd_d2b0_MC0_ddrc_0_core : public NOCDdrMcXtlm
{
public:
  bd_d2b0_MC0_ddrc_0_core( sc_core::sc_module_name nm, const xsc::common_cpp::properties& props )
  : NOCDdrMcXtlm(nm, props)
  {
  }

  virtual ~bd_d2b0_MC0_ddrc_0_core()
  {
  }
