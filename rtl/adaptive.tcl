...
#
# adaptive.tcl: Tcl script for re-creating project 'tb3d'
#
# Generated by Vivado on Mon Mar 23 18:44:54 CDT 2026
...
#
# 1. This project restoration tcl script (adaptive.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "$origin_dir/../tb3d.srcs/sources_1/bd/design_1/design_1.bd"
#    "$origin_dir/../tb3d.srcs/sources_1/imports/rtl/tb3d_decode.v"
#    "$origin_dir/../tb3d.srcs/sources_1/imports/rtl/tb3d_encode.v"
#    "$origin_dir/../tb3d.srcs/sources_1/imports/rtl/tb3d_transcoder.v"
#    "$origin_dir/../tb3d.srcs/sources_1/imports/rtl/tb3d_bit_accessor.v"
#    "$origin_dir/../tb3d.srcs/sources_1/imports/rtl/tb3d_dragonfly_cache.v"
#    "$origin_dir/../tb3d.srcs/sources_1/imports/rtl/tb3d_state_buffer.v"
#    "$origin_dir/../tb3d.srcs/sources_1/imports/rtl/tb3d_vector_engine.v"
#    "$origin_dir/../tb3d.srcs/sources_1/imports/rtl/tb3d_axi_lite_slave.v"
#    "$origin_dir/../tb3d.srcs/sources_1/imports/rtl/tb3d_dma_controller.v"
#    "$origin_dir/../tb3d.srcs/sources_1/imports/rtl/tb3d_engine_top.v"
#    "$origin_dir/../tb3d.srcs/sources_1/imports/rtl/tb3d_pcie_bridge.v"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../tb3d.srcs/sources_1/bd/design_1/design_1.bd"]"\
 "[file normalize "$origin_dir/../tb3d.srcs/sources_1/imports/rtl/tb3d_decode.v"]"\
 "[file normalize "$origin_dir/../tb3d.srcs/sources_1/imports/rtl/tb3d_encode.v"]"\
 "[file normalize "$origin_dir/../tb3d.srcs/sources_1/imports/rtl/tb3d_transcoder.v"]"\
 "[file normalize "$origin_dir/../tb3d.srcs/sources_1/imports/rtl/tb3d_bit_accessor.v"]"\
 "[file normalize "$origin_dir/../tb3d.srcs/sources_1/imports/rtl/tb3d_dragonfly_cache.v"]"\
 "[file normalize "$origin_dir/../tb3d.srcs/sources_1/imports/rtl/tb3d_state_buffer.v"]"\
 "[file normalize "$origin_dir/../tb3d.srcs/sources_1/imports/rtl/tb3d_vector_engine.v"]"\
 "[file normalize "$origin_dir/../tb3d.srcs/sources_1/imports/rtl/tb3d_axi_lite_slave.v"]"\
 "[file normalize "$origin_dir/../tb3d.srcs/sources_1/imports/rtl/tb3d_dma_controller.v"]"\
 "[file normalize "$origin_dir/../tb3d.srcs/sources_1/imports/rtl/tb3d_engine_top.v"]"\
 "[file normalize "$origin_dir/../tb3d.srcs/sources_1/imports/rtl/tb3d_pcie_bridge.v"]"\
  ]
  foreach ifile $files {
...
set_property -name "board_part" -value "xilinx.com:vpk180:part0:1.2" -objects $obj
...
set file "rtl/tb3d_transcoder.v"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
foreach rtl_file {
  rtl/tb3d_bit_accessor.v
  rtl/tb3d_dragonfly_cache.v
  rtl/tb3d_state_buffer.v
  rtl/tb3d_vector_engine.v
  rtl/tb3d_axi_lite_slave.v
  rtl/tb3d_dma_controller.v
  rtl/tb3d_engine_top.v
  rtl/tb3d_pcie_bridge.v
} {
...
set_property -name "top" -value "tb3d_transcoder" -objects $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xcvp1802-lsvc4072-2MP-e-S -flow {Vivado Synthesis 2025} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xcvp1802-lsvc4072-2MP-e-S -flow {Vivado Advanced Implementation 2025} -strategy "Vivado Advanced Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
